...
export default function RouteForm({
  ...
  const [phonePrefix, setPhonePrefix] = useState(
    routeFormData.route?.Driver_Cellphone.split("-")[0]
  );
  const [phoneSuffix, setPhoneSuffix] = useState(
    routeFormData.route?.Driver_Cellphone.split("-")[1]
  );
  ...
  const handleGoToMap = () => {
    const latAvg =
      Math.abs(
        parseFloat(routeData.Start_Point[0]) +
          parseFloat(routeData.End_Point[0])
      ) / 2;
    const lngAvg =
      Math.abs(
        parseFloat(routeData.Start_Point[1]) +
          parseFloat(routeData.End_Point[1])
      ) / 2;
    history.push(`/home/${routeData["_id"]}/${latAvg}-${lngAvg}`);
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ width: "350px" }}>
          <TextField
            ...
            onChange={e =>
              setRouteData({ ...routeData, Path_Name: e.target.value })
            }
            disabled
          />
          <DatePicker
            startingDate={new Date(routeData.Start_Date)}
            ...
            isDisabled={
              isViewOnly() || permissions.isDisabled || routeData.Is_Permanent
            }
          />
          <FormControl
            color="secondary"
          ...
          >
            ...
            <Select
              ...
              onChange={e =>
                setRouteData({ ...routeData, Status_Name: e.target.value })
              }
              disabled={
                isViewOnly() || !isAdminOrMatakUser || routeData.Is_Permanent
              }
            >
          ...
          >
            <InputLabel>Reason For Coordination</InputLabel>
            <Select
              value={routeData.Reason_Text}
              onChange={e =>
                setRouteData({ ...routeData, Reason_Text: e.target.value })
              }
            >
        ...
        <div style={{ width: "280px" }}>
          <TextField
            ...
            onChange={e =>
              setRouteData({ ...routeData, Car_Liecene_Number: e.target.value })
            }
            disabled={
              isViewOnly() || permissions.isDisabled || routeData.Is_Permanent
            }
          ...
          <TextField
            ...
            onChange={e =>
              setRouteData({ ...routeData, Driver_Name: e.target.value })
            }
            disabled={
              isViewOnly() || permissions.isDisabled || routeData.Is_Permanent
            }
      ...
      <TextField
        ...
        onChange={e =>
          setRouteData({ ...routeData, Terms_Text: e.target.value })
        }
        disabled={isViewOnly()}
      />
      <TextField
      ...
      {!isViewOnly() && (
        <Button
          ...
          color="primary"
          disabled={
            !routeData.Car_Liecene_Number ||
            !routeData.Driver_Cellphone ||
